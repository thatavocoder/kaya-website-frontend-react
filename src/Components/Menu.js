    ...
    return (
        <div>
            ...
            <div className="nav-options row">
                <ul>
                    <li className="opt-box col s3"><div></div></li>
                    <li className="opt-box col s2"><div>Know your skin</div></li>
                    <li className="opt-box col s2"><div>Measure Improvement</div></li>
                    <li className="opt-box col s2"><div>Past Recommendation</div></li>
                    <li className="opt-box col s3"><div></div></li>
                </ul>
            </div>
        </div>
